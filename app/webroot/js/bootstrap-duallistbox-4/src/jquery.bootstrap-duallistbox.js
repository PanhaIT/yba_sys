    ...
    BootstrapDualListbox.prototype = {
        init: function() {
            ...
            this.container = $('' +
                    ...
                    '   </span>' +
                    '   <input placeholder="Available" class="form-control filter" type="text">' +
                    ...
                    '   </div>' +
                    '   <input placeholder="Member of" class="form-control filter" type="text">' +
                    '   <select multiple="multiple"></select>' +
                    ' </div>' +
                    '</div>')
        ...
        setFilterPlaceHolder: function(value, refresh) {
            ...
            this.elements.filterInput1.attr('placeholder', 'Available');
            this.elements.filterInput2.attr('placeholder', 'Member of');
            if (refresh) {
                refreshSelects(this);
            }
            return this.element;
