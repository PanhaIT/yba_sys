...
class Securimage {
    ...
    function Securimage() {
        ...
        // $this->mysql_database = mysql_connect("//http://45.77.40.154/","root","");// Wamp Server
        $this->mysql_database = mysql_connect("//http://45.77.241.247/","root","111111");//Server Cloud
        $this->use_mysql_db   = true;
        $this->mysql_handle = true;

        @mysql_select_db("business_advisor", $this->mysql_database);
    }
