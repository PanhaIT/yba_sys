                                ...
                                <td>
                                    <table style="wdith:100%;margin:0px; padding:0px;">
                                        <tr>
                                            ...
                                            <td style="width:5%;"></td>
                                            <td style="background-color:#e8eeff !important; padding:5px 5px 7px 5px; border:1px dashed; font-family:cambria;"><?php echo TABLE_TOTAL_POINT; ?></td>
                                            <td style="background-color:#e8eeff !important; padding:5px 5px 7px 5px; border:1px dashed;"><span class="totaPointItem" style="font-family:cambria; font-weight:bold;">0</span></td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table>
                            ...
                            <tr>
                                <td style="vertical-align: middle; color: red;">Discount 
                                    ...
                                    <img src="<?php echo $this->webroot; ?>img/button/card.png" id="btnMembershipCard" style="width: 35px; float: right; cursor: pointer;" />
