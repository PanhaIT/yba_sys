...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#OrderAddForm").ajaxForm({
            ...
            beforeSerialize: function($form, options) {
                ...
                if($("#OrderPreviewId").val() != ''){
                    var mCode = $("#OrderBranchId").find("option:selected").attr("mcode");
            ...
            success: function(result) {
                ...
                if(result.error == "1"){
                    ...
                    if($("#OrderIsPreview").val() == '1'){
                        ...
                        $("#OrderOrderCode").val(result.code);
    ...
    function checkVatSelectedOrder(){
        ...
        $("#OrderVatPercent").val((vatPercent).toFixed(<?php echo $priceDecimal; ?>));
    }
                        ...
                        buttons: {
                            '<?php echo ACTION_OK; ?>': function() {
                                if($("input[name='chkQuotation']:checked").val()){
                                    ...
                                    var locationGroup = $("#OrderLocationGroupId").val();
                                    // Customer
                                    ...
                                    $.ajax({
                                        dataType: "json",
                                        type:   "POST",
                                        url:    "<?php echo $this->base . '/' . $this->params['controller']; ?>/getProductFromQuote/"+quoteId+"/"+locationGroup,
                                        beforeSend: function(){
                                            $(".loader").attr('src','<?php echo $this->webroot; ?>img/layout/spinner.gif');
                                        },
                                        success: function(msg){
...
<input type="hidden" value="" name="data[Order][preview_id]" id="OrderPreviewId" />
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        ...
                        <td style="vertical-align: top;">
                            <table cellpadding="0" style="width: 100%;">
                                <tr>
                                    ...
                                    <td style="width: 33%;"><label for="OrderOrderCode"><?php echo TABLE_SALES_ORDER_NUMBER; ?> <span class="red">*</span></label></td>
                                    <td style="width: 34%;"><label for="OrderQuotationNumber"><?php echo TABLE_QUOTATION_NUMBER; ?></label></td>
                                </tr>
                                <tr>
                                    <td>
                        ...
                        <td rowspan="2" style="width: 50%;">
                            <table cellpadding="0" style="width: 100%;">
                                <tr>
                                    ...
                                    <td style="width: 33%;"><?php if(count($locationGroups) > 1){ ?><label for="OrderLocationGroupId"><?php echo TABLE_LOCATION_GROUP; ?> <span class="red">*</span><?php } ?></td>
                    ...
                    <tr>
                        <td style="vertical-align: top;">
                            <table cellpadding="0" style="width: 100%;">
                                <tr>
                                    <td colspan="2"><label for="OrderCustomerName"><?php echo TABLE_CUSTOMER; ?> <span class="red">*</span></label></td>
                                    ...
                                    <td colspan="2">
                                        <div class="inputContainer" style="width:100%">
                                            ...
                                            <div class="addnewSmall" style="float: left; width: 94%;">
                                                <?php echo $this->Form->text('customer_name', array('class' => 'validate[required]', 'style' => 'width: 91%; border: none;')); ?>
                                            ...
                                            <?php 
                                                ...
                                                echo $this->Form->text('customer_name', array('class' => 'validate[required]', 'style' => 'width:90%'));
                                            }
                                            ?>
                                            <img alt="<?php echo TABLE_SHOW_CUSTOMER_LIST; ?>" align="absmiddle" style="cursor: pointer; width: 22px; height: 22px;" class="searchCustomerOrder" onmouseover="Tip('<?php echo TABLE_SHOW_CUSTOMER_LIST; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                                            <img alt="<?php echo ACTION_REMOVE; ?>" align="absmiddle" style="cursor: pointer; display: none; width: 22px; height: 22px;" class="deleteCustomerOrder" onmouseover="Tip('<?php echo ACTION_REMOVE; ?>')" src="<?php echo $this->webroot . 'img/button/pos/remove-icon-png-25.png'; ?>" />
                                        </div>
                                    </td>
                                    <td>
    ...
    <div style="float: left; width: 26%;">
        ...
        <div class="buttons">
            <button type="submit" class="positive saveOrder" >
                ...
                <span class="txtSaveOrder"><?php echo ACTION_SAVE_NEW; ?></span>
            </button>
        </div>
        <div class="buttons">
    ...
    <div style="float: right; width:73%;">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 10%;">
                    <div class="inputContainer" style="width: 100%">
                        <?php echo $this->Form->text('total_amount', array('readonly' => true, 'class' => 'float validate[required]', 'style' => 'width: 75%; font-size:12px; font-weight: bold', 'value'=>'0')); ?> <span class="lblSymbolOrder"></span>
                    </div>
                </td>
                ...
                <td style="width: 7%;">
                    <div class="inputContainer" style="width: 100%">
                        ...
                        <?php echo $this->Form->text('vat_percent', array('readonly' => true, 'class' => 'float validate[required]', 'style' => 'width: 45%; font-size:12px; font-weight: bold', 'value' => 0)); ?> <span class="lblSymbolOrderPercent">(%)</span>
                    </div>
                </td>
                <td style="width: 6%; text-align: right;"><label for="OrderTotalAmountSummary"><?php echo TABLE_TOTAL; ?>:</label></td>
                <td style="width: 12%;">
                    <div class="inputContainer" style="width: 100%">
                        <?php echo $this->Form->text('total_amount_summary', array('readonly' => true, 'class' => 'float validate[required]', 'style' => 'width: 75%; font-size:12px; font-weight: bold', 'value'=>'0')); ?> <span class="lblSymbolOrder"></span>
                    </div>
                </td>
                <td style="width: 6%; text-align: right;"><label for="OrderTotalDeposit"><?php echo TABLE_DEPOSIT; ?> :</label></td>
                <td>
                    <div class="inputContainer" style="width: 100%">
                        <?php echo $this->Form->text('total_deposit', array('class' => 'float validate[required]', 'style' => 'width: 75%; font-size:12px; font-weight: bold', 'value'=>'0')); ?> <span class="lblSymbolOrder"></span>
                    </div>
                </td>
            </tr>
        </table>
