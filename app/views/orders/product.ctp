...
<script type="text/javascript">
    $(document).ready(function(){
        var oTable<?php echo $rand; ?> = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base . '/' . $this->params['controller']; ?>/productAjax/<?php echo $companyId; ?>/<?php echo $locationGroupId; ?>/<?php echo $branchId; ?>/<?php echo $orderDate; ?>/?sale_order_id=<?php echo $saleOderId; ?>",
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $("#<?php echo $tblName; ?> tr").click(function(){
                    $(this).find("input[name='chkProductOrder']").attr("checked", true);
                });
                return sPre;
            },
            "aoColumnDefs": [{
        ...
        $("#changeCategoryOrderSelectProduct").change(function(){
            var valueId = $(this).val();
            var Tablesetting = oTable<?php echo $rand; ?>.fnSettings();
            Tablesetting.sAjaxSource = "<?php echo $this->base . '/' . $this->params['controller']; ?>/productAjax/<?php echo $companyId; ?>/<?php echo $locationGroupId; ?>/<?php echo $branchId; ?>/<?php echo $orderDate; ?>/"+valueId+"/?sale_order_id=<?php echo $saleOderId; ?>";
...
<div style="padding: 5px;border: 1px dashed #bbbbbb; margin-bottom: 5px;">
    <div style="float:right;">
        ...
        <select id="changeCategoryOrderSelectProduct" style="width:150px;">
