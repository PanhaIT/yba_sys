 ...
 */
$aColumns = array('CONCAT_WS("||",quo.id,cus.id,quo.price_type_id,quo.vat_setting_id,quo.vat_calculate,IFNULL(quo.vat_percent, 0),IFNULL(quo.discount, 0),IFNULL(quo.discount_percent, 0),IFNULL(quo.customer_contact_id, 0),IFNULL(quo.total_deposit, 0))', 'quo.quotation_code', 'quo.quotation_date', 'cus.name', 'quo.total_amount', "currency_centers.symbol");
