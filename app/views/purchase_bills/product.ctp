...
<script type="text/javascript">
    $(document).ready(function(){
        var oTable<?php echo $rand; ?> = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base . '/' . $this->params['controller']; ?>/productAjax/<?php echo $companyId; ?>/<?php echo $branchId; ?>/<?php echo $locationId; ?>/<?php echo $vendorId; ?>/"+$("#changeCategoryPurchaserderSelectProduct").val(),
    ...
    <table id="<?php echo $tblName; ?>" class="table" cellspacing="0">
        <thead>
            <tr>
                ...
                <th><?php echo TABLE_LAST_COST; ?></th>
            </tr>
        </thead>
        <tbody>
            <tr>
