...
<?php echo $this->Form->create('Employee', array('method'=>'POST','enctype'=>'multipart/form-data', 'class' => 'form form-vertical main-form','inputDefaults' => array('div' => false, 'label' => false)));?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->text('dob', array('class' => 'form-control date_of_birth','readonly'=>'readonly',  'placeholder' => 'Date of Birth' ,'style' => '')); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->text('employee_code', array('value' =>$code,'class' => 'form-control','required'=>true, 'placeholder' => 'Employee ID' ,'style' => '')); ?>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
