...
<script type="text/javascript">
    ...
    $(document).ready(function(){   
        ...
        oTableEmployee=$("#<?php echo $tblName;?>").dataTable({
            ...
            "serverSide": true,
            "autoWidth": false,
            "sAjaxSource": "<?php echo $this->base . '/'. $this->params['controller'];?>/employeeAjax",
            "url": "employees/employee_ajax.ctp",
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnDeleteEmployee").click(function(event){
                    ...
                    $.showConfirm({
                        ...
                        body: "Are you sure want to delete employee <b>"+name+"</b>?",
...
<div class="leftPanel">
    <div class="" style="border: 1px dashed #bbbbbb; width:100%; margin-top:1.5rem;">
        <a><button class="btn btn-primary btnAddEmployee text-btn-plus" ><svg class="icon-svg-custom bi" fill="currentColor"><use xlink:href="<?php echo $this->webroot;?>assets/vendors/bootstrap-icons/bootstrap-icons.svg#plus" /></svg><label class="label_crud"><?php echo MENU_EMPLOYEE_MANAGEMENT_ADD; ?></label></button></a>
    </div>
    <div class="container-fluid" style="width:100%;height:100%;padding:10px 0px 0px 0px;">
        <table id="<?php echo $tblName;?>" class="table table-hover" width="100%" cellspacing="0">
            <thead>
                <tr>
