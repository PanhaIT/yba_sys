...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#TodoListEditForm").ajaxForm({
            dataType: "JSON",
            type: "POST",
            url: "<?php echo $this->base.'/'.$this->params['controller']; ?>/edit/<?php echo $this->data['TodoList']['id'];?>",
            data: $("#TodoListEditForm").serialize(),
        ...
        $('#TodoListServiceId').change(function(){
            if($(this).val()!=""){
                $.ajax({
                    dataType: "JSON",
                    type: "GET",
                    ...
                    beforeSend: function(){},
                    success: function(result){
                        $("#TodoListServiceCode").val(result.service_code);
                        $("#TodoListSectionName").val(result.section_name);
                    }
                });
            }
        });
   ...
   function eventTodoList(){
        $(".btnAddRowSubTask, .btnRemoveRowSubTask,.TodoListServiceId").unbind('click').unbind('keyup').unbind('keypress').unbind('change').unbind('blur');
        ...
        $('.rowSubTask').each(function(event){
            var id = $(this).find(".TodoListServiceId").attr('id').split("_")[1];
...
<body>
<?php
echo $this->Form->create('TodoList', array('method'=>'POST','enctype'=>'multipart/form-data', 'class' => 'form form-vertical main-form','inputDefaults' => array('div' => false, 'label' => false)));
echo $this->Form->hidden('id', array('value'=>$this->data['TodoList']['id'])); 
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="form-group">
                                            <label for="TodoListCode"><?php echo TABLE_CODE;?></label><label class="require-label">*</label>
                                            <?php echo $this->Form->text('code', array('class' => 'form-control','readonly'=>true,'required'=>'required', 'placeholder' => TABLE_CODE ,'style' => '')); ?>
                                        </div>
                                    </div>
                                    <div class="col-sm">
                                        <div class="form-group">
                                            <label for="TodoListDate"><?php echo TABLE_DATE;?></label><label class="require-label">*</label>
                                            <?php echo $this->Form->text('date', array('class' => 'form-control','required'=>true,'readonly'=>true, 'placeholder' => TABLE_DATE ,'style' => '')); ?>
                                        </div>
                                    </div>
                                    <div class="col-sm">
                                        <div class="form-group">
                                            <label for="TodoListEstimateDate"><?php echo TABLE_ESTIMATE_DATE;?></label><label class="require-label">*</label>
                                ...
                                <div class="row equal-heights">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="TodoListTaskName"><?php echo TABLE_TASK_NAME;?></label><label class="require-label">*</label>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="row">
                                            <div class="form-group">
                                                <label for="TodoListPriorityId"><?php echo TABLE_PRIORITY;?></label><label class="require-label">*</label>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <label for="TodoListStartDate"><?php echo TABLE_START_DATE;?></label>
                                                <?php echo $this->Form->text('start_date', array('class' => 'form-control','value'=>($this->data['TodoList']['start_date']=='0000-00-00 00:00:00' || $this->data['TodoList']['start_date']==''?'':$this->data['TodoList']['start_date']),'readonly'=>true, 'placeholder' => TABLE_START_DATE ,'style' => '')); ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="row">
                                            <div class="form-group">
                                                <label for="TodoListProgresseId"><?php echo TABLE_STATUS;?></label><label class="require-label">*</label>
                                                <select name="data[TodoList][progresse_id]" id="TodoListProgresseId" class="choices form-select multiple-remove">
                                                <?php
                                                    foreach($progresses AS $key => $val){
                                                ?>
                                                <option value="<?php echo $key;?>" <?php if($this->data['TodoList']['status']==$key){?> selected="selected" <?php } ?>><?php echo $val;?></option>
                                                <?php
                                                    }
                                                ?>
                                                </select>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <label for="TodoListEndDate"><?php echo TABLE_END_DATE;?></label>
                                                <?php echo $this->Form->text('end_date', array('class' => 'form-control','readonly'=>true,'value'=>($this->data['TodoList']['end_date']=='0000-00-00 00:00:00' || $this->data['TodoList']['end_date']==''?'':$this->data['TodoList']['end_date']), 'placeholder' => TABLE_END_DATE ,'style' => '')); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="TodoListCustomerId"><?php echo TABLE_CUSTOMER; ?></label>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="TodoListEmployeeId"><?php echo TABLE_EMPLOYEE; ?></label>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="TodoListRemark"><?php echo TABLE_REMARK;?></label>
                                    <?php echo $this->Form->textarea('remark', array('class' => 'form-control','placeholder' => TABLE_NAME ,'style' => 'height:207px;')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
