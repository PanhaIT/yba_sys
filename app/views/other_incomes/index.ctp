...
<script type="text/javascript">
    var oTableOtherIncome;
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#<?php echo $tblName; ?> td:first-child").addClass('first');
        oTableOtherIncome = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnViewOtherIncome").unbind("click").click(function(event){
                ...
                $(".btnEditOtherIncome").unbind("click").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                    var leftPanel=$(this).parent().parent().parent().parent().parent().parent().parent();
                    var rightPanel=leftPanel.parent().find(".rightPanel");
                ...
                $(".btnDeleteOtherIncome").unbind("click").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
        ...
        <?php if($allowAdd){ ?>
        $(".btnAddOtherIncome").unbind("click").click(function(event){
            event.preventDefault();
...
<div class="leftPanel">
    ...
    <div style="padding: 5px;border: 1px dashed #bbbbbb;">
        <div class="buttons">
            <a href="" class="positive btnAddOtherIncome">
                <img src="<?php echo $this->webroot; ?>img/button/plus.png" alt=""/>
                <?php echo MENU_OTHER_INCOME_ADD; ?>
            </a>
        </div>
