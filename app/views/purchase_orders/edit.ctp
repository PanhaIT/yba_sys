                        ...
                        if(data){
                            $.ajax({
                                ...
                                success: function(uom){
                                    $(".loader").attr('src', '<?php echo $this->webroot; ?>img/layout/spinner-placeholder.gif');
                                    addProductPO(record[1], record[4], uom, record[0], record[3], record[5]);
                                }
                            });
                        }
                    }
                            ...
                            '<?php echo ACTION_OK; ?>': function() {
                                ...
                                if(data){
                                    $.ajax({
                                        ...
                                        success: function(uom){
                                            $(".loader").attr('src', '<?php echo $this->webroot; ?>img/layout/spinner-placeholder.gif');
                                            addProductPO($("input[name='chkProduct']:checked").attr('class'),$("input[name='chkProduct']:checked").attr('id'), uom, record[0], record[2], record[5]);
                                        }
                                    });
                                }
                                $(this).dialog("close");
                ...
                $("#dialog").dialog({
                    ...
                    buttons: {
                        ...
                        '<?php echo ACTION_YES; ?>': function() {
                            ...
                            $("#PurchaseRequestEditForm").submit();
                            $(this).dialog("close");
                        }
                    }
                });
            ...
            success: function(result) {
                ...
                if(result.code == "1"){
                    ...
                    if($("#PurchaseRequestIsPreview").val() == '1'){
                        ...
                        // Reset Normal
                        $("#PurchaseRequestPurchaseRequestId").val(result.po_id);
...
<input type="hidden" value="<?php echo $this->data['PurchaseRequest']['currency_center_id']; ?>" name="data[PurchaseRequest][currency_center_id]" id="PurchaseRequestCurrencyCenterId" />
                ...
                <td style="width: 50%">
                    <table cellpadding="0" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="inputContainer" style="width:100%">
                                    <?php echo $this->Form->text('pr_code', array('value' => $this->data['PurchaseRequest']['pr_code'], 'style' => 'width:70%', 'readonly' => true)); ?>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="inputContainer" style="width:100%;">
                                    <select name="data[PurchaseRequest][location_group_id]" id="PurchaseRequestLocationGroupId" class="validate[required]" style="width: 75%;">
                                        ...
                                        ?>
                                        <option <?php if($locationGroup['LocationGroup']['id'] == $this->data['PurchaseRequest']['location_group_id']){ ?>selected=""<?php } ?> ship="<?php echo $locationGroup['LocationGroup']['description']; ?>" value="<?php echo $locationGroup['LocationGroup']['id']; ?>"><?php echo $locationGroup['LocationGroup']['name']; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            <td colspan="2">
                                <div class="inputContainer" style="width:100%">
                                    ...
                                    <div class="addnewSmall" style="float: left;">
                                        <?php echo $this->Form->text('vendor_name', array('class' => 'validate[required]', 'style' => 'width: 285px; border: none;', 'value' => $this->data['Vendor']['name'], 'readonly' => $venReadonly)); ?>
                                    ...
                                    <?php
                                        ...
                                        echo $this->Form->text('vendor_name', array('class' => 'validate[required]', 'style' => 'width:320px', 'value' => $this->data['Vendor']['name'], 'readonly' => $venReadonly));
                                    }
                                    ?>
                                    &nbsp;&nbsp; <img alt="<?php echo TABLE_SHOW_VENDOR_LIST; ?>" align="absmiddle" style="cursor: pointer; width:22px; height: 22px; display:none;" id="searchVendorPO" onmouseover="Tip('<?php echo TABLE_SHOW_VENDOR_LIST; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                                    <img alt="<?php echo ACTION_REMOVE; ?>" align="absmiddle" id="deleteSearchVendorPO" onmouseover="Tip('<?php echo ACTION_REMOVE; ?>')" src="<?php echo $this->webroot . 'img/button/pos/remove-icon-png-25.png'; ?>" style="cursor: pointer; width:22px; height: 22px;" />
                                    <div style="clear: both;"></div>
                                </div>
                            </td>
                            <td>
...
<div id="bodyListPO">
    <table id="tblPO" class="table" cellspacing="0" style="padding:0px;">
        <tr id="detailPO" class="listBodyPO" style="visibility: hidden;">
            ...
            <td style="padding:0px; text-align: center; width:12%">
                <div class="inputContainer" style="width:100%">                                        
                    ...
                    <select id="qty_uom_id" name="qty_uom_id[]" style="width:90%; height: 25px;" class="qty_uom_id validate[required]">
                        <?php
                        foreach ($uoms as $uom) {
        ...
        <tr class="listBodyPO">
            ...
            <td style="width:10%">
                <div class="inputContainer" style="width:100%">
                    <input type="text" style="width:90%; height: 25px;"  class="product_code" value="<?php echo $orderDetail['Product']['code']; ?>" />
                </div>
            </td>
            <td style="width:18%">
                <div class="inputContainer" style="width:100%">
                    ...
                    <?php echo $this->Form->input('product_name', array('name'=>'product_name[]','id'=>'product_name'.$i, 'label' => false, 'data' => $orderDetail['Product']['name'], 'value' => $orderDetail['Product']['name']."/".$orderDetail['PurchaseRequestDetail']['conversion'], 'class'=>'product_name validate[required]', 'style'=>'width:75%; height: 25px;' , 'div'=>false));?>
            ...
            <td style="padding:0px; text-align: center; width:12%">
                <div class="input text">                                  
                    ...
                    <select name="qty_uom_id[]" class="qty_uom_id validate[required]" id="qty_uom_id<?php echo $i;?>" style="width:90%; height: 25px;" base="1">
                    <?php
            ...
            <td style="padding:0px; text-align: center; width:8%">
                <?php echo $this->Form->input('qty', array('id'=>'qty_'.$i,'name'=>'qty[]', 'label' => false, 'value' => number_format($orderDetail['PurchaseRequestDetail']['qty'], 0), 'class'=>'qty float validate[required,min[1]]', 'style'=>'width:75%; height: 25px;'));?>
            </td>
            <td style="padding:0px; text-align: center; width:8%">
                <div class="inputContainer" style="width:100%">
                    <input type="text" id="qty_free<?php echo $i; ?>" name="qty_free[]" value="<?php echo number_format($orderDetail['PurchaseRequestDetail']['qty_free'], 0); ?>" style="width:75%; height: 25px;"  class="qty_free" />
                </div>
            </td>
            <td style="padding:0px; text-align: center; width:10%">
                ...
                echo $this->Form->input('unit_cost', array('id'=>'unit_cost'.$i, 'name'=>'unit_cost[]', 'readonly' => $readonly, 'label' => false, 'value'=>number_format($orderDetail['PurchaseRequestDetail']['unit_cost'], $costDecimal), 'class'=>'unit_cost validate[required] float', 'style'=>'width:80%; height: 25px;'));?>
            </td>
            <td style="padding:0px; text-align: center; width:10%;">
                <div class="inputContainer" style="width:100%">
                    <div style="white-space: nowrap; margin-top: 3px; width: 100%">
                        <input type="hidden" name="discount_id[]" value="<?php echo $orderDetail['PurchaseRequestDetail']['discount_id']; ?>" />
                        <input type="hidden" name="discount_amount[]" value="<?php echo $orderDetail['PurchaseRequestDetail']['discount_amount']; ?>" />
                        <input type="hidden" name="discount_percent[]" value="<?php echo $orderDetail['PurchaseRequestDetail']['discount_percent']; ?>" />
                        <?php
                        if($allowDiscount){
                        ?>
                        <input type="text" name="discount[]" value="<?php echo number_format($orderDetail['PurchaseRequestDetail']['discount_amount'], 2); ?>" class="discountPO btnDiscountPO float" readonly="readonly" id="discountPO<?php echo $i; ?>" style="width: 50%; height: 25px;" /><span class="lblDisPercent"><?php if($orderDetail['PurchaseRequestDetail']['discount_percent'] > 0){ ?>(<?php echo number_format($orderDetail['PurchaseRequestDetail']['discount_percent'], 2); ?>%)<?php } ?></span>
                        <img alt="Remove" src="<?php echo $this->webroot . 'img/button/cross.png'; ?>" class="btnRemoveDiscountPO" align="absmiddle" style="cursor: pointer; display: none;" onmouseover="Tip('Remove')" />
                        <?php
                        }else{
                        ?>
                        <input type="hidden" name="discount[]" value="<?php echo number_format($orderDetail['PurchaseRequestDetail']['discount_amount'], 2); ?>" class="discountPO btnDiscountPO float" readonly="readonly" id="discountPO<?php echo $i; ?>" />
                        <?php
                        }
                        ?>
                    </div>
            ...
            <td style="padding:0px; text-align: center; width:10%">
                ...
                <?php echo $this->Form->input('total_cost', array('id'=>'total_cost'.$i, 'readonly' => $readonly, 'label' => false, 'name'=>'total_cost[]', 'value'=>number_format($orderDetail['PurchaseRequestDetail']['total_cost'] - $orderDetail['PurchaseRequestDetail']['discount_amount'], $costDecimal), 'class'=>'total_cost float', 'style'=>'width:80%; height: 25px;'));?>
            </td>
            <td style="white-space: nowrap; padding:0px; text-align: center; width:9%">
                <img alt="" src="<?php echo $this->webroot . 'img/button/cross.png'; ?>" class="btnRemovePO" style="cursor: pointer;" onmouseover="Tip('Remove')" />
                &nbsp; <img alt="Up" src="<?php echo $this->webroot . 'img/button/move_up.png'; ?>" class="btnMoveUpPO" align="absmiddle" style="cursor: pointer;" onmouseover="Tip('Up')" />
        ...
        <tr class="listBodyPO">
            ...
            <td style="width:10%;">
                <div class="inputContainer" style="width:100%">
                    <input type="text" style="width:90%; height: 25px;"  class="product_code" value="<?php echo $purchaseRequestService['Service']['code']; ?>" />
                </div>
            </td>
            <td style="width:18%">
                <div class="inputContainer" style="width:100%">
                    ...
                    <?php echo $this->Form->input('product_name', array('name'=>'product_name[]','id'=>'product_name'.$i, 'label' => false, 'value' => $purchaseRequestService['Service']['name'], 'class'=>'product_name validate[required]', 'style'=>'width:75%; height: 25px;' , 'div'=>false));?>
                    <img alt="Note" id="noteAddPO<?php echo $i;?>" src="<?php echo $this->webroot . 'img/button/note.png'; ?>" class="noteAddPO" align="absmiddle" style="cursor: pointer;" onmouseover="Tip('Note')" />
                </div>
            </td>
            <td style="padding:0px; text-align: center; width:12%">
            ...
            <td style="padding:0px; text-align: center; width:8%">
                <?php echo $this->Form->input('qty', array('id'=>'qty_'.$i,'name'=>'qty[]', 'label' => false, 'value' => number_format($purchaseRequestService['PurchaseRequestService']['qty'], 0), 'class'=>'qty float validate[required,min[1]]', 'style'=>'width:80%; height: 25px;'));?>
            </td>
            <td style="padding:0px; text-align: center; width:8%">
                <div class="inputContainer" style="width:100%">
                    <input type="text" id="qty_free<?php echo $i; ?>" name="qty_free[]" value="<?php echo number_format($purchaseRequestService['PurchaseRequestService']['qty_free'], 0); ?>" style="width:75%; height: 25px;"  class="qty_free" />
                </div>
            </td>
            <td style="padding:0px; text-align: center; width:10%">
                ...
                echo $this->Form->input('unit_cost', array('id'=>'unit_cost'.$i, 'name'=>'unit_cost[]', 'readonly' => $readonly, 'label' => false, 'value'=>number_format($purchaseRequestService['PurchaseRequestService']['unit_cost'], $costDecimal), 'class'=>'unit_cost validate[required] float', 'style'=>'width:80%; height: 25px;'));?>
            </td>
            <td style="padding:0px; text-align: center; width:10%;">
                <div class="inputContainer" style="width:100%">
                    <div style="white-space: nowrap; margin-top: 3px; width: 100%">
                        <input type="hidden" name="discount_id[]" value="<?php echo $purchaseRequestService['PurchaseRequestService']['discount_id']; ?>" />
                        <input type="hidden" name="discount_amount[]" value="<?php echo $purchaseRequestService['PurchaseRequestService']['discount_amount']; ?>" />
                        <input type="hidden" name="discount_percent[]" value="<?php echo $purchaseRequestService['PurchaseRequestService']['discount_percent']; ?>" />
                        <?php
                        if($allowDiscount){
                        ?>
                        <input type="text" name="discount[]" value="<?php echo number_format($purchaseRequestService['PurchaseRequestService']['discount_amount'], 2); ?>" class="discountPO btnDiscountPO float" readonly="readonly" id="discountPO<?php echo $i; ?>" style="width: 60%; height: 25px;" /><span class="lblDisPercent"><?php if($purchaseRequestService['PurchaseRequestService']['discount_percent'] > 0){ ?>(<?php echo number_format($purchaseRequestService['PurchaseRequestService']['discount_percent'], 2); ?>%)<?php } ?></span>
                        <img alt="Remove" src="<?php echo $this->webroot . 'img/button/cross.png'; ?>" class="btnRemoveDiscountPO" align="absmiddle" style="cursor: pointer; display: none;" onmouseover="Tip('Remove')" />
                        <?php
                        }else{
                        ?>
                        <input type="hidden" name="discount[]" value="<?php echo number_format($purchaseRequestService['PurchaseRequestService']['discount_amount'], 2); ?>" class="discountPO btnDiscountPO float" readonly="readonly" id="discountPO<?php echo $i; ?>" />
                        <?php
                        }
                        ?>
                    </div>
            ...
            <td style="padding:0px; text-align: center; width:10%">
                ...
                <?php echo $this->Form->input('total_cost', array('id'=>'total_cost'.$i, 'readonly' => $readonly, 'label' => false, 'name'=>'total_cost[]', 'value'=>number_format($purchaseRequestService['PurchaseRequestService']['total_cost'] - $purchaseRequestService['PurchaseRequestService']['discount_amount'], $costDecimal), 'class'=>'total_cost float', 'style'=>'width:80%; height: 25px;'));?>
            </td>
            <td style="white-space: nowrap; padding:0px; text-align: center; width:9%">
                <img alt="" src="<?php echo $this->webroot . 'img/button/cross.png'; ?>" class="btnRemovePO" style="cursor: pointer;" onmouseover="Tip('Remove')" />
                &nbsp; <img alt="Up" src="<?php echo $this->webroot . 'img/button/move_up.png'; ?>" class="btnMoveUpPO" align="absmiddle" style="cursor: pointer;" onmouseover="Tip('Up')" />
    ...
    <div style="float: right; width:70%; vertical-align: bottom;" id="amountPaid">
        <table cellpadding="0" style="width:100%; padding: 0px; margin: 0px;">
            <tr>
                ...
                <td style="width:18%">
                    <?php echo $this->Form->text('total_amount', array('readonly' => true, 'style' => 'width: 80%; height:15px; font-size:12px; font-weight: bold', 'value' => number_format($this->data['PurchaseRequest']['total_amount'], $costDecimal))); ?> <span class="lblSymbolPO"><?php echo $this->data['CurrencyCenter']['symbol']; ?></span>
                </td>
                ...
                <td style="width:19%">
                    <?php echo $this->Form->text('total_amount_all', array('readonly' => true, 'style' => 'width: 80%; height:15px; font-size:12px; font-weight: bold' , 'value' => number_format(($this->data['PurchaseRequest']['total_amount'] + $this->data['PurchaseRequest']['total_vat']), $costDecimal))); ?> <span class="lblSymbolPO"><?php echo $this->data['CurrencyCenter']['symbol']; ?></span>
                </td>
            </tr>
        </table>
    </div>
