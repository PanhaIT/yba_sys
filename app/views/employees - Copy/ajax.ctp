 ...
 */
//$aColumns = array('id', 'photo', 'employee_code', 'name', 'name_kh', 'sex', 'personal_number', 'is_finger_enroll', 'is_active');
$aColumns = array('id', 'photo', 'employee_code', 'name', 'name_kh', 'sex', 'personal_number', 'is_active');
...
//            ($allowView ? '<a href="" class="btnEnrollEmployee" rel="' . $aRow[0] . '" name="' . $aRow[3] . '"><img alt="Enroll" onmouseover="Tip(\'' . ACTION_EDIT . '\')" src="' . $this->webroot . 'img/button/fingerprint.png" /></a> ' : '') .
