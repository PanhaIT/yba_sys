            ...
            <tr>
                ...
                <td>
                    <select id="PgroupParentId" name="data[Pgroup][parent_id]">
                        ...
                        <?php
                        $sqlParent = mysql_query("SELECT id, name, (SELECT GROUP_CONCAT(company_id) FROM pgroup_companies WHERE pgroup_id = pgroups.id) AS company_id FROM pgroups WHERE is_active = 1");
