    ...
    $(document).ready(function(){
        ...
        $("#VendorEditForm").ajaxForm({
            ...
            success: function(result) {
                ...
                $(".btnBackVendor").click();
                // alert message
                if(result != '<?php echo MESSAGE_DATA_HAS_BEEN_SAVED; ?>' && result != '<?php echo MESSAGE_DATA_ALREADY_EXISTS_IN_THE_SYSTEM; ?>' && result != '<?php echo MESSAGE_DATA_COULD_NOT_BE_SAVED; ?>'){
