...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#VendorEditVendorForm").ajaxForm({
            type: "POST",
            url: "<?php echo $this->base.'/'.$this->params['controller']; ?>/editVendor/<?php echo $this->data['Vendor']['id'];?>",
            data: $("#VendorEditVendorForm").serialize(),
        ...
        $(".<?php echo $btnRemoveUploadPhoto;?>").click(function(){
            var moduleId     = $('#VendorId').val();
            var photoName    = $('#oldVendorPhoto').val();
...
<body>
<?php
echo $this->Form->create('Vendor', array('method'=>'POST','enctype'=>'multipart/form-data', 'class' => 'form form-vertical main-form','inputDefaults' => array('div' => false, 'label' => false)));
echo $this->Form->hidden('id', array('value'=>$this->data['Vendor']['id'])); 
echo $this->Form->hidden('sys_code');
?>
<div class="app form-body">
    <div class="page-title">
        <div class="row">
            <input type="hidden" id="<?php echo $photoNameHidden; ?>"​ value="" name="data[Vendor][new_photo]" />
            <input type="hidden" id="oldVendorPhoto" name="data[Vendor][old_photo]" value="<?php echo $this->data['Vendor']['photo']; ?>" />
        </div>
        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->text('vendor_code', array('class' => 'form-control','readonly'=>true,'required'=>true, 'placeholder' => TABLE_VENDOR_NUMBER ,'style' => '')); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->input('vgroup_id', array('selected' => $vgroupsSellected,'empty' => INPUT_SELECT,'required'=>'required', 'class' => 'choices form-select multiple-remove')); ?>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                            ...
                            <div class="col-6 col-md-4" style="padding-top:auto; padding-bottom:auto;">
                                <div class="row">
                                    ...
                                    <div class="col" style="text-align:center;">
                                        ...
                                        <a href="#" style="color:white;height:150px; width:100%;<?php if($this->data["Vendor"]['photo']==''){?> display:none; <?php } ?>" class="<?php echo $btnRemoveUploadPhoto;?>">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->input('company_id', array('selected' => $companySellected,'empty' => INPUT_SELECT,'class' => 'choices form-select multiple-remove')); ?>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
