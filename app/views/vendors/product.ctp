        ...
        $("#<?php echo $tblName; ?>").dataTable({
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $("#<?php echo $tblName; ?> tr").click(function(){
                    if($(this).find("input[name='chkVendorProduct']").is(":checked")){
                        $(this).find("input[name='chkVendorProduct']").removeAttr("checked");
                    } else {
                        $(this).find("input[name='chkVendorProduct']").attr("checked", true);
                    }
                });
                return sPre;
            },
