...
<script type="text/javascript">
    $(document).ready(function(){
        $("#CustomerAddCustomerForm").ajaxForm({
            type: "POST",
            url: "<?php echo $this->base.'/'.$this->params['controller']; ?>/addCustomer",
            data: $("#CustomerAddCustomerForm").serialize(),
        ...
        FilePond.create(document.querySelector('#<?php echo $uploadPhoto;?>'), {
            ...
            server: {
                process: (fieldName, file, metadata, load, error, progress, abort) => {
                    ...
                    request.open('POST', '<?php echo $this->base.'/'.$this->params['controller']; ?>/uploadCustomer');
...
<?php echo $this->Form->create('Customer', array('method'=>'POST','enctype'=>'multipart/form-data', 'class' => 'form form-vertical main-form','inputDefaults' => array('div' => false, 'label' => false)));?>
<div id="app form-body">
    <div class="page-title">
        <div class="row">
            <input type="hidden" value="" name="data[Customer][photo]" id="employeePhotoId"/>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->text('customer_code', array('value' => $code, 'class' => 'form-control','required'=>'required', 'placeholder' => TABLE_CUSTOMER_NUMBER ,'style' => '')); ?>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="first-name-icon"><?php echo TABLE_GROUP; ?></label><label class="require-label">*</label>
                                            <?php echo $this->Form->input('cgroup_id', array('empty' => INPUT_SELECT,'required'=>'required', 'class' => 'choices form-select multiple-remove')); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->text('payment_every', array('value' => 0, 'class' => 'form-control','required'=>'required', 'placeholder' => TABLE_PAYMENT_EVERY ,'style' => '')); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <?php echo $this->Form->text('mobile_number', array('class' => 'mobile-id-icon','class' => 'form-control','required'=>true, 'placeholder' => TABLE_MOBILE ,'style' => '')); ?>
                                        <div class="form-control-icon">
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <?php echo $this->Form->text('email', array('class' => 'email-id-icon','class' => 'form-control','required'=>true, 'placeholder' => TABLE_EMAIL ,'style' => '')); ?>
                                        <div class="form-control-icon">
