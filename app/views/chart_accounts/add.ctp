...
<input type="hidden" name="data[ChartAccount][company_id][]" value="1" />
<fieldset>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->input('chart_account_type_id', array('empty' => INPUT_SELECT, 'label' => false, 'class'=>'validate[required]')); ?>
                </div>
            </td>
        </tr>
        <tr>
...
<!--<fieldset>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="vertical-align: top;">
                <select id="d" name="data[ChartAccount][company_id][]" multiple="multiple" style="width: 300px; height: 200px;"></select>
            </td>
        </tr>
    </table>
</fieldset>
