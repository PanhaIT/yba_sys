...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        // Prevent Key Enter
        preventKeyEnter();
        $("#MembershipCardAddForm").validationEngine();
        // Action Save
        $("#MembershipCardAddForm").ajaxForm({
...
<fieldset>
    ...
    <table style="width: 100%;">
                ...
                <div class="inputContainer" style="width: 100%;">
                    <select id="MembershipCardCgroupId" class="cgroup" style="width: 295px;" data-placeholder="<?php echo INPUT_SELECT; ?>" name="data[MembershipCard][cgroup_id]">
                        ...
                        foreach ($cgroups as $cgroup) {
                            $queryCustomerGroupName = mysql_query("SELECT (SELECT GROUP_CONCAT(company_id) FROM cgroup_companies WHERE cgroup_id = cgroups.id GROUP BY cgroup_id) AS company_id,name FROM cgroups WHERE is_active=1 AND id=" . $cgroup['Cgroup']['id']);
                            if (mysql_num_rows($queryCustomerGroupName)) {
                                $dataCustomerGroupName = mysql_fetch_array($queryCustomerGroupName);
                                ?>
                                <option value="<?php echo $cgroup['Cgroup']['id']; ?>" company_id="<?php echo $dataCustomerGroupName['company_id']; ?>"><?php echo $dataCustomerGroupName['name']; ?></option>
                                <?php
                            }
                        }
                        ?>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer" style="width: 100%;">
                    <input type="hidden" id="MembershipCardCustomerId" name="data[MembershipCard][customer_id]" value="">
                    <?php echo $this->Form->text('name', array('class' => 'validate[required]', 'id' => 'MembershipCardName', 'style' => 'width: 64%;')); ?>                    
                    <img alt="Search" align="absmiddle" style="cursor: pointer; width: 22px; height: 22px;" class="searchCustomer" onmouseover="Tip('<?php echo GENERAL_SEARCH; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                    <img alt="Delete" align="absmiddle" style="display: none; cursor: pointer;" class="deleteCustomer" onmouseover="Tip('<?php echo ACTION_DELETE; ?>')" src="<?php echo $this->webroot . 'img/button/delete.png'; ?>" />
                </div>
            </td>  
            <td style="width: 15%;"><label for="MembershipCardMainNumberAdd"><?php echo TABLE_TELEPHONE; ?> <span class="red">*</span>:</label></td>
            <td style="width: 35%;">
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->text('main_number', array('class' => 'validate[required]', 'id' => 'MembershipCardMainNumberAdd', 'style' => 'width: 64%;')); ?>
                </div>
            </td>        
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->text('email', array('class' => 'validate[optional,custom[email]]', 'style' => 'width: 64%;')); ?>
                </div>
            </td>
            <td><label for="MembershipCardDob"><?php echo TABLE_DOB; ?>:</label></td>
            <td>
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->text('dob', array('readonly' => true, 'style' => 'width: 64%;')); ?>                    
                    <span>
                        <?php echo TABLE_AGE; ?>
                        <?php echo $this->Form->text('age', array('class' => 'validate[optional,max[150]', 'style' => 'width:30px;', 'maxlength' => 3)); ?>
                    </span>
                </div>
            </td>
        </tr>
        <tr>            
            ...
            <td>
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->text('address', array('style' => 'width: 64%;')); ?> 
                </div>             
            </td>
        </tr>
        <tr>
    ...
    <table style="width: 100%;">
        <tr>            
            ...
            <td>
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->text('card_date_start', array('class' => 'validate[required]', 'style' => 'width: 284px;', 'readonly' => true)); ?> 
                </div>             
            </td>
            <td><label for="MembershipCardCardDateEnd"><?php echo TABLE_DATE_END; ?> <span class="red">*</span> :</label></td>
            <td>
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->text('card_date_end', array('class' => 'validate[required]', 'style' => 'width: 284px;', 'readonly' => true)); ?> 
                </div>             
            </td>
...
<fieldset>
    ...
    <table id="discount-save" style="width: 100%;" cellspacing="0">               
        <tr>
        ...
        <tr>
            ...
            <td style="width: 25%;">
                <input type="hidden" name="data[MembershipCard][total_point]" value="1" class="validate[required,max[100]] float">
                <?php //echo $this->Form->text('total_point', array('class' => 'validate[required,max[100]] float', 'style' => 'width:80px;','value'=>1, 'maxlength' => '3')); ?> 1 Point(s)
            </td>
            <td style="width: 25%;">
                <?php echo $this->Form->text('exchange_point', array('class' => 'validate[required,max[100]] float','value'=>1, 'style' => 'width:80px;', 'maxlength' => '3')); ?> Point(s) = <?php echo $this->Form->text('point_in_dollar', array('class' => 'validate[required] float','value'=>1, 'style' => 'width:80px;')); ?> Dollar(s)
            </td>
        </tr>
    </table>
    <table id="top-up-discount" style="width: 100%;" cellspacing="0">               
        <tr>
