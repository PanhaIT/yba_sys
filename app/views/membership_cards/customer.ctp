...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var oSOCustomerTable = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base . '/' . $this->params['controller']; ?>/customerAjax/<?php echo $companyId.'/'.$customerGroupId; ?>?sale_id=<?php echo $saleId; ?>",
        ...
        $("#changeSOCustomerGroup").change(function(){
            ...
            Tablesetting.sAjaxSource = "<?php echo $this->base . '/' . $this->params['controller']; ?>/customerAjax/<?php echo $companyId; ?>/"+valueId+"?sale_id=<?php echo $saleId; ?>";
...
<div style="padding: 5px;border: 1px dashed #bbbbbb; margin-bottom: 5px;">
    <div style="float:right;">
        ...
        <select id="changeSOCustomerGroup" style="width:150px;">
            ...
            ?>
            <option <?php if($dataPgroup['id']==$customerGroupId) echo 'selected="selected"';?> value="<?php echo $dataPgroup['id']; ?>"><?php echo $dataPgroup['name']; ?></option>
            <?php
            }
            ?>
        </select>
