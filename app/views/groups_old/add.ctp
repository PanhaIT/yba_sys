...
<fieldset>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="vertical-align: top;">
                <select id="userGroupMember" name="data[Group][user_id][]" multiple="multiple" style="width: 300px; height: 200px;"></select>
            </td>
        </tr>
    </table>
</fieldset>
    ...
    while ($dataType = mysql_fetch_array($queryType)) {
        ...
        <div class="moduleTypeBody" style="padding-left: 10px; display: none;" title="<?php echo $rand; ?>">
            ...
            while ($dataModule = mysql_fetch_array($queryModule)) {
                ?>
                <div class="module">
                    <div style="float: left; font-size: 12px;"><?php echo $dataModule['name']; ?></div>
                    <div style="float: right;"><input type="checkbox" name="module<?php echo $dataModule['id']; ?>" class="moduleType<?php echo $dataType['id']; ?> moduleCheck" alt="<?php echo $dataType['id']; ?>" /></div>
                    <div style="clear: both;"></div>
                </div>
            <?php } ?>
        </div>
