...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(".btnRefreshGroup").unbind("click").click(function(){
            $("#<?php echo $tblName; ?>").find("tbody").html('<tr><td colspan="3" class="dataTables_empty"><?php echo TABLE_LOADING; ?></td></tr>');
            oCache.iCacheLower = -1;
            oTableGroup.fnDraw(false);
        });
    });
...
<div class="leftPanel">
    <div style="padding: 5px;border: 1px dashed #bbbbbb;">
        ...
        <div class="buttons" style="float: right; margin-left: 10px;">
            <button type="button" class="positive btnRefreshGroup">
