...
<div id="<?php echo $printArea; ?>">
    ...
    if($allowExpired == true){
        $excelColExp = "\t".TABLE_EXP_DATE_SHORT;
    }
    $excelContent .= TABLE_NO."\t".TABLE_SKU."\t".TABLE_LOCATION.$excelColLot.$excelColExp."\t".TABLE_TOTAL_QTY."\t".TABLE_UOM;
    ?>
    <table id="<?php echo $tblName; ?>" class="table_report">
        <tr>
            <th class="first"><?php echo TABLE_NO; ?></th>
            <th style="width: 90px !important;"><?php echo TABLE_BARCODE; ?></th>
            <th><?php echo TABLE_LOCATION; ?></th>
            <th style="width: 120px !important; <?php if($allowLost == false){ ?>display: none;<?php } ?>"><?php echo TABLE_LOTS_NO; ?></th>
            <th style="width: 120px !important; <?php if($allowExpired == false){ ?>display: none;<?php } ?>"><?php echo TABLE_EXP_DATE_SHORT; ?></th>
        ...
        if($sqlCmtDailyEnding != ''){
            ...
            if($allowExpired == true){
                ...
                $excelExpired = "\t".$expiredDate;
            }
            $excelContent .= "\n".$index++."\t".$oldProductCode."\t".$data['location_name'].$excelListLot.$excelExpired."\t".$subTotalEBI."\t".$small_label; ?>
            <tr>
                ...
                <td style="text-align: center; <?php if($allowExpired == false){ ?>display: none;<?php } ?>"><?php echo $expiredDate; ?></td>
