...
$aColumns = array(
    ...
    'type',
    'date',
    '(SELECT name FROM branches WHERE id=gld.branch_id)',
    'IF(gl.sales_order_id != "", (SELECT so_code FROM sales_orders WHERE id =gl.sales_order_id), (SELECT cm_code FROM credit_memos WHERE id =gl.credit_memo_id))',
    'reference',
...
$condition .= " AND (type = 'Receive Payment' OR type = 'Invoice Payment')";
if ($data[1] != '') {
