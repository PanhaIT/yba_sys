            ...
            <tr>
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        ...
                        echo $this->Form->select($company, $companies, null, array('escape' => false, 'name' => 'company_id', 'empty' => $emptyCom)); ?>
                    </div>
                </td>
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        ...
                        echo $this->Form->select($branch, $branches, null, array('escape' => false, 'name' => 'branch_id', 'empty' => $emptyBra)); ?>
                    </div>
                </td>
