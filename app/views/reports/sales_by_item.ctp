    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if($("#<?php echo $columns; ?>").val() == 1){
                url="<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/salesByItemResult";
            }
...
<div class="legend">
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                <td style="width: 8%;"><label for="<?php echo $columns; ?>"><?php echo TABLE_VIEW_BY; ?>:</label></td>
                <td style="width: 15%;">
                    <select id="<?php echo $columns; ?>">
                        <option value="1" selected="selected">Item Summary</option>
                        <option value="2">Item Detail</option>
                    </select>
                </td>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <select id="<?php echo $vendor; ?>" class="<?php echo $vendor; ?> chzn-select" name="vendor_id[]" multiple="multiple" data-placeholder="<?php echo TABLE_ALL; ?>" style="width: 240px; height: 40px;">
                            <?php
                            $queryVendor = mysql_query("SELECT id, name FROM vendors WHERE is_active = 1");
                            while($rowVendor = mysql_fetch_array($queryVendor)){
                            ?>
                            <option value="<?php echo $rowVendor['id']; ?>"><?php echo $rowVendor['name']; ?></option>
                            <?php             
                            }
                            ?>
                        </select>
