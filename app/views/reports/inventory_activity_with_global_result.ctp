...
<div id="<?php echo $printArea; ?>">
    ...
    <table id="<?php echo $tblName; ?>" class="table_report">
        ...
        $tableDaily = "";
        $tableDailyBbi = "";
        $filedDailyBbi = "SUM((total_pb + total_sr + total_to_in + total_inv_adj + total_cus_consign_in + total_ven_consign_in) - (total_si + total_pbr + total_pos + total_to_out + total_cus_consign_out + total_ven_consign_out)) AS total_qty, product_id";
        $filedDaily = "SUM((total_pb + total_sr + total_to_in + total_inv_adj + total_cus_consign_in + total_ven_consign_in) - (total_si + total_pbr + total_pos + total_to_out + total_cus_consign_out + total_ven_consign_out)) AS total_qty, uoms.name AS u_name, products.price_uom_id AS qty_uom_id, products.parent_id AS parent_id, products.code AS product_code, products.name AS product_name, products.id AS product_id, (SELECT CONCAT(' ',code,name) FROM products WHERE id = products.parent_id LIMIT 1) AS parent_name";
