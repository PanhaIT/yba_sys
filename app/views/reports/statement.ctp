        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(isFormValidated){
                if($("#<?php echo $customerId; ?>").val()==""){
                    ...
                    var url = "<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/statementResult";
                    if($("#<?php echo $columns; ?>").val() == 2){
                        url = "<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/statementOpenInvoice";
                    }
                    $.ajax({
                        type: "POST",
                        url: url,
            ...
            <tr>
                ...
                <td style="width: 15%;">
                    <select id="<?php echo $columns; ?>">
                        <option value="1" selected="selected">Balance Detail</option>
                        <option value="2">Open Invoice</option>
                    </select>
                </td>
                <td></td>
            </tr>
