...
<div class="legend">
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                <td style="width: 8%;"><label for="<?php echo $payment; ?>"><?php echo 'Payment Method'; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <select name="payment_method" id="<?php echo $payment; ?>">
                            <option value=""><?php echo TABLE_ALL; ?></option>
                            <?php
                            $sqlPM = mysql_query("SELECT * FROM pos_pay_methods WHERE is_active = 1");
                            while($rowPM = mysql_fetch_array($sqlPM)){
                            ?>
                            <option value="<?php echo $rowPM['id']; ?>"><?php echo $rowPM['name']; ?></option>
                            <?php
                            }
                            ?>
                        </select>
