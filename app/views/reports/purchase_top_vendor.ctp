    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if($("#<?php echo $show; ?>").val() == 1){
                url = 'purchaseTopVendorResult';
            } else {
                url = 'purchaseTopVendorGraph';
            }
            if(isFormValidated){
                $.ajax({
                    type: "POST",
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_PURCHASE_TOP_BOTTOM_VENDOR; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
