...
<div id="<?php echo $printArea; ?>">
    ...
    $excelContent .= TABLE_NO."\t".TABLE_NAME. "\t" . MENU_DEPARTMENT. "\t" . MENU_PRODUCT_GROUP_MANAGEMENT. "\t" . TABLE_SUB_OF_GROUP . "\t" . "Sub-Sub Catergory"."\t".TABLE_INVOICE_CODE."\t".TABLE_VENDOR."\t".TABLE_LOCATION_GROUP."\t".TABLE_QTY."\t".TABLE_UOM."\t".TABLE_TOTAL_COST;
    ?>
    <table id="<?php echo $tblName; ?>" class="table_report">
        ...
        ?>
            ...
            <?php $excelContent .= "\n".$index."\t".$oldProductName."\t".getProductRelation($oldProductId, 4)."\t".getProductRelation($oldProductId, 3)."\t".getProductRelation($oldProductId, 2)."\t".getProductRelation($oldProductId, 1)."\t\t\t\t".$subTotalQty."\t".$oldUomName."\t".number_format($subTotalAmount,2); ?>
