            ...
            <tr>
                ...
                <td style="width: 42%;">
                    <div class="inputContainer" style="width: 100%;">
                        <select id="<?php echo $branch; ?>" class="<?php echo $branch; ?> chzn-select" name="branch_id[]" multiple="multiple" data-placeholder="<?php echo TABLE_BRANCH; ?>" style="width: 95%; height: 40px;">
                            <?php
                            $queryBranch = mysql_query("SELECT id, name FROM branches WHERE id IN (SELECT branch_id FROM user_branches WHERE user_id = " . $user['User']['id'].")");
            ...
            <tr>
                ...
                <td style="width: 36%;">
                    <div class="inputContainer">
                        ...
                        <?php echo $this->Form->text($vendor, array('escape' => false, 'name' => '', 'style' => 'width: 65%;')); ?>
                ...
                <td style="width: 6%;"><label for="<?php echo $other; ?>" style="display: none;"><?php echo TABLE_OTHER; ?>:</label></td>
                <td style="width: 15%;">
                ...
                <td style="width: 8%;"><label for="<?php echo $class; ?>" style="display: none;"><?php echo TABLE_CLASS; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer" style="display: none;">
