...
/* DB table to use */
$sTable = " credit_memos
            LEFT JOIN customers ON customers.id = credit_memos.customer_id INNER JOIN currency_centers ON currency_centers.id = credit_memos.currency_center_id";
