...
<div style="width: 54%; float: left;">
    <table width="100%" cellpadding="5" style="width: 100%;">
        ...
        <tr<?php if($allowBarcode == false){ ?> style="display: none;"<?php } ?>>
            <td><label for="ProductBarcode"><?php echo TABLE_BARCODE; ?> :</label></td>
            <td>
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->input('barcode', array('div' => false, 'style' => 'width: 270px;', 'placeholder' => TABLE_AUTO_GENERATE)); ?>
        ...
        <tr>
            ...
            <td><?php echo $this->Form->textarea('spec', array('style' => 'width: 270px; height: 50px;')); ?></td>
        </tr>
        <tr>
            <td style="vertical-align: top;"><label for="ProductDescription"><?php echo GENERAL_DESCRIPTION; ?> :</label></td>
            <td><?php echo $this->Form->textarea('description', array('style' => 'width: 270px; height: 50px;')); ?></td>
        </tr>
    </table>
</div>
