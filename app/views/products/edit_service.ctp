...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        ?>
        $("#ProductEditServiceForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#ProductEditServiceForm").ajaxForm({
        ...
        $(".btnBackProduct").click(function(event){
            ...
            var rightPanel = $("#ProductEditServiceForm").parent();
...
<fieldset style="width: 98%;">
    ...
    <table cellpadding="5">
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('name', array('class' => 'validate[required]', 'style' => 'width: 340px;  height: 25px;', 'value' => $this->data['Service']['name'])); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->input('pgroup_id', array('empty' => INPUT_SELECT, 'selected' => $this->data['Service']['section_id'])); ?>
                </div>
            </td>
        </tr>
        <tr <?php if($allowBarcode == false){ ?> style="display: none;"<?php } ?>>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('code', array('style' => 'width: 340px;', 'placeholder' => TABLE_AUTO_GENERATE, 'value' => $this->data['Service']['code'])); ?>
                </div>
            </td>
        </tr>
        <tr id="ProductUomDiv">
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->input('uom_id', array('empty' => INPUT_SELECT, 'selected' => $this->data['Service']['uom_id'])); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('unit_price', array('class' => 'float validate[required]', 'style' => 'width: 340px;', 'value' => number_format($this->data['Service']['unit_price'], $salesDecimal))).' '.$rowSym[0]; ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->textarea('description', array('style' => 'width: 340px;', 'value' => $this->data['Service']['description'])); ?>
                </div>
            </td>
        </tr>
    </table>
