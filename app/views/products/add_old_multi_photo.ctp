...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // $(".ProductPhotoMultiData").each(function(){
        //     var rel = $(this).find(".ProductPhoto").attr("rel");
        //     $("#ProductPhoto_"+rel).click(function(){
        //         rowIndexMultiPhoto = rel;
            ...
            <table id="tblMutiPhoto">
                <tr id="OrderListMutiPhoto" class="tblMutiPhotoList">
                    ...
                    <td>
                        ...
                        <img alt="Remove" src="<?php echo $this->webroot . 'img/button/cross.png'; ?>" class="btnnRemoveMultiPhoto" align="absmiddle" style="cursor: pointer; display:none;" onmouseover="Tip('Remove')" />
                    </td>
                    <td>
                        <img alt="Remove" src="<?php echo $this->webroot . 'img/button/cross.png'; ?>" class="btnnRemoveMultiPhoto" align="absmiddle" style="cursor: pointer; display:none;" onmouseover="Tip('Remove')" />
                    </td>
