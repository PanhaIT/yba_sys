...
<!--                    <input type="hidden" class="qrCodeItem" value="<?php echo $item['code']; ?>" />
                ...
                <td style="text-align: right; font-size: 15px; font-family: 'arialbd'; vertical-align: top; font-weight: bold; line-height: 15px;">
                    <?php echo $item['name']; ?><span class="lblConversion" style="font-size: 15px; font-family: 'arialbd'; font-weight: bold;">/<?php echo $item['uom_label']; ?></span>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <div style="padding: 0px; margin: 0px; width: 44%; float: left;">
                    ...
                    <div style="padding: 0px; margin: 0px; width: 55%; float: right; text-align: right; font-size: 11px; font-family: 'Arial';">
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        <tr>
                            <td style="vertical-align: top;">
                                <?php
                                $sqlP = mysql_query("SELECT * FROM product_qty_prices WHERE product_id = ".$item['id']." GROUP BY qty ORDER BY qty ASC");
                                if(mysql_num_rows($sqlP)){
                                    while($rowP = mysql_fetch_array($sqlP)){
                                        $prmoSplit = split ("\.", number_format($rowP['unit_price'], 2)); 
                                        if(!empty($prmoSplit[1])){
                                            $mainPromo = $prmoSplit[0];
                                            $sencPromo = $prmoSplit[1];
                                        } else {
                                            $mainPromo = $rowP['unit_price'];
                                            $sencPromo = '00';
                                        }
                                ?>
                                <div style="float: left; width: 77px;">
                                    <table cellpadding="0" cellspacing="0" style="line-height:13px; width: 100%;">
                                        <tr>
                                            <td style="text-align: right; font-weight: bold; font-family: 'MC-sans'; font-size: 18px;">
                                                <?php echo $mainPromo; ?>
                                            </td>
                                            <td style="width: 32px;">
                                                <div style="width: 100%; text-align: center; vertical-align: top;">
                                                    <div style="font-size: 12px; padding: 0px; font-family: 'MC-sans';" class="decimalPrice">.<?php echo $sencPromo; ?></div>
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding: 0px;">
                                                <div style="width: 100%; border: 1px solid #000; padding: 0px; font-size: 12px; font-weight: bold;">
                                                    in <?php echo $rowP['qty']; ?> bottles
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                ?>
                                <div style="float: right; text-align: right; font-weight: bold; font-family: 'MC-sans'; font-size: 35px; width: 70px;" class="mainPrice">
                                    <?php echo $mainPrice; ?>
                                </div>
                            </td>
                            <td style="width: 37px;">
