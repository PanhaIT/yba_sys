...
<script type="text/javascript">
    $(document).ready(function(){
        backEventView(oTableGroup,"btnBackGroup");
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link btnBackGroup" is-breadcrumb="1"><?php echo MENU_CUSTOMER_GROUP_MANAGEMENT;?></a></li>
                        ...
                        <table class="table table-hover mb-0 view_item_list">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-bold-500"><?php echo $this->data['Group']['name']; ?></td>
                                </tr>
                                <tr>
                                    <th class="border-bottom-cus"><?php echo MENU_COMPANY_MANAGEMENT;?></th>
                                    <td class="text-bold-500 border-bottom-cus">
                                    <?php 
                                        $sqlCompany=mysql_query("SELECT GROUP_CONCAT(c.name SEPARATOR ', ') FROM companies c INNER JOIN Group_companies cc ON cc.company_id=c.id INNER JOIN Groups cg ON cg.id=cc.Group_id WHERE c.is_active=1 AND cg.id='".$this->data['Group']['id']."'");
