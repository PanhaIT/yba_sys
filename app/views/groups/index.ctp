...
<script type="text/javascript">
    ...
    $(document).ready(function(){   
        ...
        $('.btnAddGroup').unbind('click').click(function (event) {
            event.preventDefault();
...
<div class="leftPanel">
    <div class="" style="border: 1px dashed #bbbbbb; width:100%; margin-top:1.5rem;">
        <a><button class="btn btn-primary btnAddGroup text-btn-plus" type="Add new"><svg class="icon-svg-custom bi" fill="currentColor"><use xlink:href="<?php echo $this->webroot.PATH_ICON_BOOTSTRAP;?>plus" /></svg><label class="label_crud"><?php echo MENU_CUSTOMER_GROUP_MANAGEMENT_ADD; ?></label></button></a>
    </div>
