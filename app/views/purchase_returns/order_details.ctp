...
<script type="text/javascript">
    ...
    function getTotalAmountPR(){
        ...
        totalVat   = replaceNum(converDicemalJS((totalAmtCalVat * totalVatPer) / 100).toFixed(<?php echo $costDecimal; ?>));
        grandTotal = totalAmount + totalVat;
        $("#PurchaseReturnTotalAmount").val((totalAmount).toFixed(<?php echo $costDecimal; ?>));
        $("#PurchaseReturnTotalVat").val((totalVat).toFixed(<?php echo $costDecimal; ?>));
        $("#PurchaseReturnSubTotalAmount").val((grandTotal).toFixed(<?php echo $costDecimal; ?>));
    }
