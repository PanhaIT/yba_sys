...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#CustomerEditCustomerForm").ajaxForm({
            type: "POST",
            url: "<?php echo $this->base.'/'.$this->params['controller']; ?>/editCustomer/<?php echo $this->data['Customer']['id'];?>",
            data: $("#CustomerEditCustomerForm").serialize(),
            beforeSerialize: function(formData, formOptions) {  
                if($("#CustomerCgroupId").val() == null || $("#CustomerCgroupId").val() == ""){
                    alertSelectRequireField('customer_group');
                    return false;
                }
                if($("#CustomerPaymentTermId").val() == null || $("#CustomerPaymentTermId").val() == ""){
        ...
        $(".<?php echo $btnRemoveUploadPhoto;?>").click(function(){
            var moduleId     = $('#CustomerId').val();
            var photoName    = $('#oldCustomerPhoto').val();
            var newPhotoName = $('#<?php echo $photoNameHidden; ?>').val();
            $.showConfirm({
                title: "<?php echo MENU_CUSTOMER_PHOTO;?>",
                ...
                onSubmit: function(result) {
                    if(result){
                        $.ajax({
                            type: "POST",
                            url: "<?php echo $this->base.'/'.$this->params['controller']; ?>/removePhotoTmpCustomer",
        ...
        smartImageLoader();
        choicesSelect('#CustomerCgroupId,#CustomerPaymentTermId');
        backEventModule(oTableCustomer,"btnBackCustomer");
    });

    function alertSelectRequireField(type){
        var bodyMessage="";
        if(type=='customer_group'){
            bodyMessage="<?php echo TABLE_ALERT_SELECT_CUSTOMER_GROUP;?>";
        ...
        FilePond.create(document.querySelector('.<?php echo $uploadPhoto;?>'), {
            ...
            server: {
                process: (fieldName, file, metadata, load, error, progress, abort) => {
                    ...
                    request.open('POST', '<?php echo $this->base.'/'.$this->params['controller']; ?>/uploadPhotoCustomer');
                    ...
                    request.onreadystatechange = function() {
                        if (this.readyState == 4) {
                            if (this.status == 200) {
                                ...
                                let photoFolder = 'public/customer_photo/tmp/thumbnail/';
...
<body>
<?php
echo $this->Form->create('Customer', array('method'=>'POST','enctype'=>'multipart/form-data', 'class' => 'form form-vertical main-form','inputDefaults' => array('div' => false, 'label' => false)));
...
<div class="app form-body">
    <div class="page-title">
        <div class="row">
            <input type="hidden" id="<?php echo $photoNameHidden; ?>"​ value="" name="data[Customer][new_photo]" />
            <input type="hidden" id="oldCustomerPhoto" name="data[Customer][old_photo]" value="<?php echo $this->data['Customer']['photo']; ?>" />
        </div>
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="first-name-icon"><?php echo TABLE_NAME_IN_ENGLISH;?></label><label class="require-label">*</label>
                                            <?php echo $this->Form->text('name', array('class' => 'form-control','required'=>'required', 'placeholder' => TABLE_NAME_IN_ENGLISH ,'style' => '')); ?>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="first-name-icon"><?php echo TABLE_NAME_IN_KHMER;?></label><label class="require-label">*</label>
                                            <?php echo $this->Form->text('name_kh', array('class' => 'form-control','required'=>true, 'placeholder' => TABLE_NAME_IN_KHMER ,'style' => '')); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 col-md-4">
                                ...
                                <div class="col-12">
                                        <div class="form-group">
                                            <label for="first-name-icon"><?php echo TABLE_CUSTOMER_NUMBER; ?></label><label class="require-label">*</label>
                                            <?php echo $this->Form->text('customer_code', array('readonly' => true, 'class' => 'form-control','required'=>'required', 'placeholder' => TABLE_CUSTOMER_NUMBER ,'style' => '')); ?>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="first-name-icon"><?php echo TABLE_GROUP; ?></label><label class="require-label">*</label>
                                            <?php echo $this->Form->input('cgroup_id', array('selected' => $cgroupsSellected, 'empty' => INPUT_SELECT,'required'=>'required', 'class' => 'choices form-select multiple-remove')); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 col-md-4" style="padding-top:auto; padding-bottom:auto;">
                                <div class="row">
                                    ...
                                    <div class="col" style="text-align:center;">
                                        ...
                                        <a href="#" style="color:white;height:150px; width:100%;<?php if($this->data["Customer"]['photo']==''){?> display:none; <?php } ?>" class="<?php echo $btnRemoveUploadPhoto;?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-4">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="first-name-icon"><?php echo TABLE_PAYMENT_EVERY; ?></label>
                                            <?php echo $this->Form->text('payment_every', array('value' => 0, 'class' => 'form-control', 'placeholder' => TABLE_PAYMENT_EVERY ,'style' => '')); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <?php echo $this->Form->text('main_number', array('class' => 'mobile-id-icon','class' => 'form-control','required'=>true, 'placeholder' => TABLE_TELEPHONE ,'style' => '')); ?>
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    <label for="mobile-id-icon"><?php echo TABLE_MOBILE; ?></label>
                                    <div class="position-relative">
                                        <?php echo $this->Form->text('mobile_number', array('class' => 'mobile-id-icon','class' => 'form-control', 'placeholder' => TABLE_MOBILE ,'style' => '')); ?>
                                        <div class="form-control-icon">
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <?php echo $this->Form->text('email', array('class' => 'email-id-icon','class' => 'form-control','placeholder' => TABLE_EMAIL ,'style' => '')); ?>
                                        <div class="form-control-icon">
    ...
    <div style="z-index:100;padding:1px 15px 5px 0px;margin:0px 0px 0px 0px; bottom:0px;position:fixed;width:100%; height:50px;">
        ...
        <a style="color:white;">
            <button type="submit" class="btn btn-primary btnSaveCustomer text-btn-cus" style="">
