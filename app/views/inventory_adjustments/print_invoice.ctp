...
<div class="print_doc">
    ...
    $queryCycleProduct = mysql_query("  SELECT *,
                                        (SELECT name FROM branches WHERE id = cycle_products.branch_id) AS branch_name,
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td style="vertical-align: top; text-align: center; width: 75%; font-size: 15px; font-weight: bold;">
                ប័ណ្ណស្នើសុំចុះតម្រូវ ទំនិញ (ស្តុក) 
            </td>
            <td style="text-align: left; width: 10%; font-size: 11px;">ADJ No:</td>
            <td style="white-space: nowrap; font-size: 11px;">
                <?php echo $dataCycleProduct['reference']; ?>
            </td>
        </tr>
        <tr>
            <td style="vertical-align: top; text-align: center; width: 75%; font-size: 15px; font-weight: bold;">
                GOODS REQUEST ADJUSTMENT (STOCK)
            </td>
        ...
        <tr>
            ...
            <td style="text-align: left; width: 10%; font-size: 11px;">Created:</td>
            <td style="white-space: nowrap;">
                <?php
                $sqlUser = mysql_query("SELECT * FROM users WHERE id = ".$dataCycleProduct['created_by']);
                $rowUser = mysql_fetch_array($sqlUser);
                echo dateShort($dataCycleProduct['created'], "d/m/Y H:i:s")." ".$rowUser['first_name']." ".$rowUser['last_name'];
                ?>
            </td>
        </tr>
        <tr>
    ...
    <div>
        <div>
            <table class="table_print">
                <tr>
                    ...
                    <th style="width: 100px !important; font-size: 10px;"><?php echo 'តម្លៃសរុប'; ?></th>
                ...
                <tr>
                    ...
                    <th style="width: 100px !important; font-size: 10px; <?php if($allowLots == false){ ?>display: none;<?php } ?>"><?php echo TABLE_LOTS_NO; ?></th>
                    <th style="width: 100px !important; font-size: 10px; <?php if($allowExpired == false){ ?>display: none;<?php } ?>"><?php echo TABLE_EXPIRED_DATE; ?></th>
                    <th style="width: 100px !important; font-size: 10px;"><?php echo 'TOTAL COST'; ?></th>
                ...
                <tr>
                    ...
                    <td style="text-align: center; font-size: 10px;">
                        <?php
                            $totalCost = $value * $dataDetail['unit_cost'];
                            $grandTotal += $totalCost;
                            echo number_format($totalCost, 3);
                        ?>
                    </td>
                    <td style="text-align: center; font-size: 10px;">
                        <?php
                ...
                <?php } ?>
                <tr>
                    <td class="first" colspan="5" style="text-align: right;">Total</td>
                    <td style="text-align: center;"><?php echo number_format($grandTotal, 3); ?></td>
                    <td></td>
                </tr>
            </table>
        </div>
        ...
        <table style="width: 100%;">
            <tr>
                <td style="text-align: left; font-size: 10px; width: 25%;">Request By:</td>
                <td style="text-align: left; font-size: 10px; width: 25%;">Checked By:</td>
                <td style="text-align: left; font-size: 10px; width: 25%;">Verify By:</td>
                <td style="text-align: left; font-size: 10px; width: 25%;">Approved By:</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align: center; font-size: 10px;">Finance Manager</td>
                <td style="text-align: center; font-size: 10px;">MD/CEO</td>
            </tr>
        </table>
