...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#ExpenseBranchId").unbind('change').change(function(){
            var mCode  = $(this).find("option:selected").attr("mcode");
            $("#ExpenseReference").val("<?php echo date("y"); ?>"+mCode);
        });
                ...
                success: function(msg){
                    ...
                    $("#dialog").dialog({
                        ...
                        buttons: {
                            ...
                            '<?php echo ACTION_SAVE; ?>': function() {
                                var formName = "#ExpenseTypeAddExpenseTypeForm";
                                var validateBack =$(formName).validationEngine("validate");
                                if(!validateBack){
                                    return false;
                                }else{
                                    ...
                                    $.ajax({
                                        ...
                                        data: $("#ExpenseTypeAddExpenseTypeForm").serialize(),
                                        beforeSend: function(){
                                            $(".loader").attr('src','<?php echo $this->webroot; ?>img/layout/spinner.gif');
                                        },
                                        error: function (result) {
                                        ...
                                        success: function(result){
                                            ...
                                            if(result.error == 0){
                                                // Update Brand
                                                $("#"+objId).html(result.option);
                                                $("#"+objId).trigger("chosen:updated");
                                                msg = '<?php echo MESSAGE_DATA_HAS_BEEN_SAVED; ?>';
                                            } else if(result.error == 2){
                                                msg = '<?php echo MESSAGE_DATA_ALREADY_EXISTS_IN_THE_SYSTEM; ?>';
                                            }
...
<fieldset>
    ...
    <table>
        <tr>
            <td style="width: 25%;"><label for="ExpenseDate"><?php echo TABLE_DATE; ?> <span class="red">*</span> :</label></td>
            <td>
            ...
            <td>
                <div class="inputContainer">
                    ...
                    <div class="addnewSmall" style="float: left;">
                        <?php echo $this->Form->text('vendor_name', array('style' => 'width: 285px; border: none;')); ?>
                    ...
                    <?php
                        ...
                        echo $this->Form->text('vendor_name', array('style' => 'width:320px'));
                    }
                    ?>
