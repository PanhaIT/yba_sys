    ...
    $(document).ready(function(){
        ...
        oTableExpense = $("#<?php echo $tblName; ?>").dataTable({
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnViewExpense").unbind("click").click(function(event){
                ...
                $(".btnEditExpense").unbind("click").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                    var leftPanel=$(this).parent().parent().parent().parent().parent().parent().parent();
                    var rightPanel=leftPanel.parent().find(".rightPanel");
                ...
                $(".btnDeleteExpense").unbind("click").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
        ...
        <?php if($allowAdd){ ?>
        $(".btnAddExpense").unbind("click").click(function(event){
            event.preventDefault();
        ...
        $(".btnRefreshExpense").unbind("click").click(function(){
...
<div class="leftPanel">
    <div style="padding: 5px;border: 1px dashed #bbbbbb;">
        ...
        <div class="buttons" style="float: right; margin-left: 10px;">
            <button type="button" class="positive btnRefreshExpense">
