...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#EmployeeTypeAddForm").ajaxForm({
            type: "POST",
            url: "<?php echo $this->base.'/'.$this->params['controller']; ?>/add",
            data: $("#EmployeeTypeAddForm").serialize(),
            beforeSerialize: function(formData, formOptions) {
                // if($("#EmployeeTypeCompanyId").val() == null || $("#EmployeeTypeCompanyId").val() == ""){
...
<?php echo $this->Form->create('EmployeeType', array('method'=>'POST','enctype'=>'multipart/form-data', 'class' => 'form form-vertical main-form','inputDefaults' => array('div' => false, 'label' => false)));?>
