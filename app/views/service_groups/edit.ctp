...
<script type="text/javascript">
    $(document).ready(function(){
        $("#ServiceGroupEditForm").ajaxForm({
            type: "POST",
            url: "<?php echo $this->base.'/'.$this->params['controller']; ?>/edit/<?php echo $this->data['ServiceGroup']['id'];?>",
            data: $("#ServiceGroupEditForm").serialize(),
...
echo $this->Form->hidden('id', array('value'=>$this->data['ServiceGroup']['id'])); 
