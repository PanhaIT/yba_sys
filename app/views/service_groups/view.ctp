...
<script type="text/javascript">
    $(document).ready(function(){
        backEventView(oTableServiceGroup,"btnBackServiceGroup");
    });
</script>
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <p class="text-subtitle text-muted">ServiceGroup information</p>
            </div>
            <div class="col-12 col-md-6">
                    ...
                    <div class="row">
                        <table class="table table-hover mb-0 view_item_list">
                            <tbody>
                                <tr>
                                    <th>Name</th>
                                    <td class="text-bold-500"><?php echo $this->data['ServiceGroup']['name']; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
