...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#SlideDisplayEditForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#SlideDisplayEditForm").ajaxForm({
...
<?php 
echo $this->Form->create('SlideDisplay'); 
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <input type="hidden" id="<?php echo $photoNameHidden; ?>" name="data[SlideDisplay][new_photo]" />
                    <input type="hidden" name="data[SlideDisplay][old_photo]" value="<?php echo $this->data['SlideDisplay']['photo']; ?>" />
