...
<script type="text/javascript">
    ...
    function branchChangeConsignment(obj){
        ...
        $("#ConsignmentCurrencyId").val(currency);
...
<input type="hidden" value="<?php echo $this->data['Consignment']['currency_id']; ?>" id="ConsignmentCurrencyId" name="data[Consignment][currency_id]" />
<?php
$pType = "";
