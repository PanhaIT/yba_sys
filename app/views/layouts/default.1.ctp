...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <!-- <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/demo_style.css" /> -->
        <!-- <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/smart_wizard.css" /> -->
        <!-- <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/smart_wizard_vertical.css" />
        <script type="text/javascript" src="<?php echo $this->webroot; ?>js/jquery.smartWizard.js"></script> -->



        <!-- <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/bootstrap/bootstrap.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/bootstrap/bootstrap.css.map" />
        <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/bootstrap/bootstrap.min.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/bootstrap/bootstrap.min.css.map" />
        <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/bootstrap/bootstrap-grid.css"/>
        <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/bootstrap/bootstrap-grid.css.map" />
        <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/bootstrap/bootstrap-grid.min.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/bootstrap/bootstrap-grid.min.css.map" />
        <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/bootstrap/bootstrap-reboot.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/bootstrap/bootstrap-reboot.css.map"/>
        <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/bootstrap/bootstrap-reboot.min.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>css/bootstrap/bootstrap-reboot.min.css.map"/> -->


        <!-- <script type="text/javascript" src="<?php echo $this->webroot; ?>js/bootstrap/bootstrap.bundle.js"></script>
        <script type="text/javascript" src="<?php echo $this->webroot; ?>js/bootstrap/bootstrap.bundle.js.map"></script>
        <script type="text/javascript" src="<?php echo $this->webroot; ?>js/bootstrap/bootstrap.bundle.min.js"></script>
        <script type="text/javascript" src="<?php echo $this->webroot; ?>js/bootstrap/bootstrap.bundle.min.js.map"></script>
        <script type="text/javascript" src="<?php echo $this->webroot; ?>js/bootstrap/bootstrap.js"></script>
        <script type="text/javascript" src="<?php echo $this->webroot; ?>js/bootstrap/bootstrap.js.map"></script>
        <script type="text/javascript" src="<?php echo $this->webroot; ?>js/bootstrap/bootstrap.min.js"></script>
        <script type="text/javascript" src="<?php echo $this->webroot; ?>js/bootstrap/bootstrap.min.js.map"></script> -->
        ...
        <div class="ui-layout-south">
            <div style="float: left;">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <img alt="" src="<?php echo $this->webroot; ?>img/logo_s.png" style="height:65%;position: absolute; top: 8px; left: 15px; max-height: 70px; max-width: 150px;" />
                        </td>
                    </tr>
                </table>
            </div>
            <div style="float: right;">&copy; Copyright <?php echo $start; ?><?php echo date("Y") != $start ? "-" . date("Y") : ""; ?> Neak Srok. All rights reserved. V.1.0.0</div>
        </div>
