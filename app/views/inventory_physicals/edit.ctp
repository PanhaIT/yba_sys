...
<fieldset id="topInventoryPhysical">
    ...
    <table cellpadding="3" cellspacing="0" style="width: 100%;">
        <tr>
            ...
            <td rowspan="2">
                <div class="inputContainer" style="width:100%;">
                    <textarea style="width: 90%; height: 70px;" id="InventoryPhysicalNote" name="data[InventoryPhysical][note]" class="validate[required]"><?php echo $this->data['InventoryPhysical']['note']; ?></textarea>
                </div>
            </td>
