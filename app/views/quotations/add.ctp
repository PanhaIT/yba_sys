    ...
    $(document).ready(function(){
        ...
        $("#QuotationAddForm").ajaxForm({
            ...
            beforeSerialize: function($form, options) {
                ...
                if($("#QuotationPreviewId").val() != ''){
                    var mCode = $("#QuotationBranchId").find("option:selected").attr("mcode");
            ...
            success: function(result) {
                ...
                if(result.error == "1"){
                    ...
                    if($("#QuotationIsPreview").val() == '1'){
                        ...
                        $("#QuotationQuotationCode").val(result.code);
    ...
    function errorSaveQuotation(){
        ...
        $("#dialog").dialog({
            ...
            close: function(){
                ...
                $(this).dialog("close");
                var rightPanel=$("#QuotationAddForm").parent();
                var leftPanel=rightPanel.parent().find(".leftPanel");
                rightPanel.hide();rightPanel.html("");
                leftPanel.show("slide", { direction: "left" }, 500);
                oCache.iCacheLower = -1;
...
<input type="hidden" value="" name="data[Quotation][preview_id]" id="QuotationPreviewId" />
    ...
    <tr>
        <td style="width: 50%;">
            <fieldset id="QuotationInformation">
                <legend><?php __(MENU_QUOTATION_INFO); ?> <img alt="Share" align="absmiddle" style="cursor: pointer; width: 22px; height: 22px; display: none;" class="btnShareQuotation" onmouseover="Tip('<?php echo TABLE_SHARE_OPTION; ?>')" src="<?php echo $this->webroot . 'img/button/share.png'; ?>" /></legend>
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <tr>
                        <td style="vertical-align: top;">
                            <table cellpadding="0" style="width: 100%;">
                                <tr>
                                    <td colspan="2"><label for="QuotationCustomerName"><?php echo TABLE_CUSTOMER; ?> <span class="red">*</span></label></td>
                                ...
                                <tr>
                                    <td>
                                        <div class="inputContainer" style="width:100%">
                                            ...
                                            ?>
                                            <img alt="<?php echo TABLE_SHOW_CUSTOMER_LIST; ?>" align="absmiddle" style="cursor: pointer; width: 22px; height: 22px;" class="searchCustomerQuotation" onmouseover="Tip('<?php echo TABLE_SHOW_CUSTOMER_LIST; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                                            <img alt="<?php echo ACTION_REMOVE; ?>" align="absmiddle" style="cursor: pointer; display: none; width: 22px; height: 22px;" class="deleteCustomerQuotation" onmouseover="Tip('<?php echo ACTION_REMOVE; ?>')" src="<?php echo $this->webroot . 'img/button/pos/remove-icon-png-25.png'; ?>" />
                                        </div>
                                    </td>
                                    <td>
    ...
    <div style="float: left; width: 26%;">
        ...
        <div class="buttons">
            <button type="submit" class="positive saveQuotation" >
                ...
                <span class="txtSaveQuotation"><?php echo ACTION_SAVE_NEW; ?></span>
            </button>
        </div>
        <div class="buttons">
    ...
    <div style="float: right; width:73%;">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 10%;">
                    <div class="inputContainer" style="width: 100%">
                        <?php echo $this->Form->text('total_amount', array('readonly' => true, 'class' => 'float validate[required]', 'style' => 'width: 75%; font-size:12px; font-weight: bold', 'value'=>'0')); ?> <span class="lblSymbolQuotation"></span>
                    </div>
                </td>
