                            ...
                            <div class="col-6 col-md-4" style="padding-top:auto; padding-bottom:auto;">
                                <div class="row">
                                    ...
                                    <div class="col" style="text-align:center;">
                                        ...
                                        <a href="#" style="color:white;height:150px; width:100%;<?php if($this->data["Company"]['photo']==''){?> display:none; <?php } ?>" class="<?php echo $btnRemoveUploadPhoto;?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-4">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <br><label for="first-name-icon"><?php echo TABLE_BASE_CURRENCY; ?></label><label class="require-label">*</label><br>
                                            <?php 
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <label for="mobile-id-icon"><?php echo TABLE_WEBSITE; ?></label><label class="require-label">*</label>
                                <div class="position-relative">
                                    <?php echo $this->Form->text('website', array('class' => 'form-control','required'=>true, 'placeholder' => TABLE_WEBSITE ,'style' => '')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
