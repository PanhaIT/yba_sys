...
<nav class="navbar navbar-header navbar-expand navbar-light" style="margin-top:0px;border-bottom: 0px solid #181c32;">
    ...
    <div class="collapse navbar-collapse container-fluid" id="navbarSupportedContent">
        <ul class="navbar-nav d-flex align-items-center navbar-light ms-auto">
            ...
            <li>
                <div class="d-none d-md-block d-lg-inline-block" style="color:#555;">
                    [ 
                    <a href="#" style="color:#0d6efd;">
                        <svg class="icon-svg-username bi" style="width:16px; height:16px;color:#0d6efd;" fill="currentColor"><use xlink:href="<?php echo $this->webroot.PATH_ICON_BOOTSTRAP;?>box-arrow-left" /></svg>&nbsp;<?php echo $html->link(GENERAL_LOG_OUT,array('controller'=>'users','action'=>'logout', 'id' => 'actionLogout')); ?>
                    </a> 
                    ]
                </div>
            </li>
