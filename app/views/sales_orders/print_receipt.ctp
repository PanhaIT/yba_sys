...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        try{
            ...
            var title = "receipt_<?php echo $salesOrder['Customer']['name'].'_'.$salesOrder['SalesOrder']['so_code'].'('.$salesOrder['SalesOrder']['created'].')';?>";
            try {
                // same-origin frame
                ...
                p.document.title = "receipt_<?php echo $salesOrder['Customer']['name'].'_'.$salesOrder['SalesOrder']['so_code'].'('.$salesOrder['SalesOrder']['created'].')';?>";
