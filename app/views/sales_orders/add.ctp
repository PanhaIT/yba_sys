...
//        $('#dialog').dialog('destroy');
        ...
        $("#SalesOrderAddForm").ajaxForm({
            ...
            beforeSerialize: function($form, options) {
                ...
                if(access == true){
                    ...
                    if($("#SalesOrderPreviewId").val() != ''){
                        var mCode  = $("#SalesOrderBranchId").find("option:selected").attr("mcode");
            ...
            success: function(result) {
                ...
                if(result.error == "1"){
                    ...
                    if($("#SalesOrderIsPreview").val() == '1'){
                        ...
                        $("#SalesOrderSoCode").val(result.code);
        ...
        $(".deleteCustomerSales").click(function(){
            if($(".tblSOList").find(".product_id").val() == undefined && $("#SalesOrderQuotationNumber").val() == ""){
                removeCustomerSales();
            } else {
        ...
        $("#SalesOrderCustomerName").autocomplete("<?php echo $this->base . "/customers/searchCustomer"; ?>", {
            ...
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: "<?php echo $this->base . '/sales_orders'; ?>/customerCondition/"+customerId+"/0",
                beforeSend: function(){
                },
...
<input type="hidden" value="" name="data[SalesOrder][preview_id]" id="SalesOrderPreviewId" />
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="inputContainer" style="width:100%">
                                ...
                                <?php echo $this->Form->text('quotation_number', array('style' => 'width:70%')); ?>
                                <img alt="Search" align="absmiddle" style="cursor: pointer; width: 22px; height: 22px;" class="searchQuotationSales" onmouseover="Tip('<?php echo GENERAL_SEARCH; ?>')" src="<?php echo $this->webroot . 'img/button/search.png'; ?>" />
                                <img alt="Delete" align="absmiddle" style="display: none; cursor: pointer;" class="deleteQuotationSales" onmouseover="Tip('<?php echo ACTION_DELETE; ?>')" src="<?php echo $this->webroot . 'img/button/delete.png'; ?>" />
                            </div>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="inputContainer" style="width:100%;">
                                ...
                                <?php echo $this->Form->text('order_number', array('style' => 'width:70%')); ?>
            ...
            <td style="width: 16%; vertical-align: top;" rowspan="2">
                <table cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            <div class="inputContainer" style="width:100%">
                                <?php echo $this->Form->input('memo', array('style' => 'width:90%; height: 60px;')); ?>
                            </div>
                        </td>
                    </tr>
                </table>
    ...
    <div style="float: left; width: 26%;">
        ...
        <div class="buttons">
            <button type="submit" class="positive saveSales" >
                ...
                <span class="txtSaveSales"><?php echo ACTION_SAVE_NEW; ?></span>
            </button>
        </div>
        <div class="buttons">
    ...
    <div style="float: right; width: 72%;">
        <table style="width:100%">
            <tr>
                ...
                <td style="width:7%; text-align: right;"><label for="SalesOrderDiscountUs"><?php echo GENERAL_DISCOUNT; ?>:</label></td>
                <td style="width:16%;">
                    <div class="inputContainer" style="width:100%">
                ...
                <td style="width:8%;">
                    <div class="inputContainer" style="width:100%">
                        ...
                        <?php echo $this->Form->text('vat_percent', array('value' => 0, 'readonly' => true, 'style' => 'width: 45%; height:15px; font-size:12px; font-weight: bold', 'class' => 'float')); ?> <span class="lblSymbolSalesPercent">(%)</span>
                    </div>
                </td>
                ...
                <td>
                    <div class="inputContainer" style="width: 100%">
                        <?php echo $this->Form->text('total_deposit', array('class' => 'float validate[required]', 'style' => 'width: 75%; font-size:12px; font-weight: bold', 'value'=>'0')); ?> <span class="lblSymbolSales"></span>
                    </div>
                </td>
            </tr>
        </table>
