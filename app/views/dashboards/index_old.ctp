...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        ?>
        $("#adjIssuedView").load("<?php echo $this->base; ?>/inv_adjs/viewAdjustmentIssued/"+$("#filterBranchAdjustmentIssued").val());
        <?php        
            }
        ?>
...
if($viewAdjIssued){
?>
<div class="boxDashboard" role="inv_adjs/viewAdjustmentIssued" display="<?php echo $displayAdjIssued; ?>" confirm="<?php echo MESSAGE_CONFIRM_HIDE; ?>" dialog="<?php echo DIALOG_CONFIRMATION; ?>" cancel="<?php echo ACTION_CANCEL; ?>" hide="<?php echo TABLE_HIDE; ?>" style="<?php echo $viewAdjIssuedDisp; ?>">
...
if($viewReorderLevel){
?>
<div class="boxDashboard" role="inv_adjs/viewReorderLevel" display="<?php echo $displayReorderLevel; ?>" confirm="<?php echo MESSAGE_CONFIRM_HIDE; ?>" dialog="<?php echo DIALOG_CONFIRMATION; ?>" cancel="<?php echo ACTION_CANCEL; ?>" hide="<?php echo TABLE_HIDE; ?>" style="<?php echo $viewReorderLevelDisp; ?>">
